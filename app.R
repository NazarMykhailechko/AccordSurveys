...
questions <- data.frame(
  question = c( 
    ...
    rep("Адміністративно-господарське управління (Ревуцький Володимир Васильович)",11),
    rep("Департамент банкнотного бізнесу (Комашко Олена Леонідівна)",11),
    rep("Департамент безпеки (Ткачук Іван Васильович)",11),
    rep("Департамент валютного нагляду (Лосенко Руслан Петрович)",11),
    rep("Департамент інформаційних технологій (Семенцул Євген Валентинович)",11),
    rep("Департамент казначейських операцій (Єфремов Юрій Володимирович)",11),
    rep("Департамент корпоративного бізнесу (Клевацький Денис Сергійович)",11),
    rep("Департамент маркетингу (Кривоус Ірина Анатоліївна)",11),
    rep("Департамент ризик-менеджементу (Войтків Микола Володимирович)",11),
    rep("Департамент розвитку картк. бізнесу та спожив. кредит. (Кутас Олександр Володимирович)",11),
    rep("Департамент розвитку неторгових операцій (Музика Андрій Іванович)",11),
    rep("Департамент розвитку регіональної мережі (Олійник Ігор Анатолійович)",11),
    rep("Департамент розвитку розрах. операцій та депозит. продуктів (Мулюкова Леся Олексіївна)",11),
    rep("Кредитний департамент (Голеня Олександр Євгенович)",11),
    rep("Операційний департамент (Баклаєва Вікторія Олександрівна)",11),
    rep("Управління по роботі з персоналом (Кирилішина Тетяна Вікторівна)",11),
    rep("Управління фінансового моніторингу (Черняк Віталій Васильович)",11),
    rep("Фінансово-економічний департамент (Балун Дмитро Леонідович)",11),
    rep("Юридичний департамент (Булгаков Павло Андрійович)",11),
...
option = option <- c(
  ...
  dependence = NA,
  dependence_value = NA,
  required = c(rep(TRUE, 418),rep(FALSE, 1))
