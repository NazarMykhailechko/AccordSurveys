...
questions <- data.frame(
  ...
  option = option <- c(
    ...
    "3 - залучається вибірково, участь не постійна",
    ...
    "5 – дуже мотивує – регіональний директор надихає, підримує, створює атмосферу довіри та відповідальності",
...
ui <- shiny::fluidPage(use_shiny_title(),
  ...
  opacity:1;
          ...
          <script>
              ...
              document.getElementById('div1').innerHTML = '<img width=\"35\" height=\"35\" src=\"Accord_logos.png\">             Опитування            ';
              ...
              document.getElementById('div3').innerHTML = '<img width=\"35\" height=\"35\" src=\"Accord_logos.png\">             Опитування            ';
              ...
              document.getElementById('div5').innerHTML = '<img width=\"35\" height=\"35\" src=\"Accord_logos.png\">             Опитування            ';
              ...
              document.getElementById('div6').innerHTML = '<img width=\"35\" height=\"35\" src=\"Accord_logos.png\">             Опитування            ';
